...
namespace AgileFx.AgileModeler
{
	...
	/// </summary>
	public static partial class InheritanceBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::AgileFx.AgileModeler.ModelClass)
			{ 
				return true;
			}
			else
			...
			else // Check combinations
			{
				if (candidateSource is global::AgileFx.AgileModeler.ModelClass)
				{
					if (candidateTarget is global::AgileFx.AgileModeler.ModelClass)
					{
						...
						if(targetModelClass == null || global::AgileFx.AgileModeler.Inheritance.GetLinkToBaseclass(targetModelClass) != null) return false;
						if(targetModelClass == null || sourceModelClass == null || global::AgileFx.AgileModeler.Inheritance.GetLinks(sourceModelClass, targetModelClass).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::AgileFx.AgileModeler.ModelClass)
				{
					if (target is global::AgileFx.AgileModeler.ModelClass)
					{
						...
						DslModeling::ElementLink result = new global::AgileFx.AgileModeler.Inheritance(sourceAccepted, targetAccepted);
		...
		private partial class InheritanceConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				if (targetShapeElement != null)
				{
					...
					// The Inheritance connection tool specifies that source and target should be reversed.
					// base.CanCreateConnection must be called to check whether existing Locks prevent this link from getting created.
