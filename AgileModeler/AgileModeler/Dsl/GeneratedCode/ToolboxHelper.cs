...
namespace AgileFx.AgileModeler
{
	...
	/// </remarks>
	public partial class AgileModelerToolboxHelper : AgileModelerToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new AgileModelerToolboxHelper.
		/// </summary>
		public AgileModelerToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class AgileModelerToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify AgileModeler toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "AgileModeler.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new AgileModelerToolboxHelperBase.
		/// </summary>
		protected AgileModelerToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::AgileFx.AgileModeler.AgileModelerDomainModel.SingletonResourceManager.GetString("Class DiagramsToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::AgileFx.AgileModeler.AgileModelerDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "AgileFx.AgileModeler.DslPackage.ModelClassToolboxItem":
					// Add ModelClass shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"AgileFx.AgileModeler.DslPackage.ModelClassToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"AgileFx.AgileModeler.DslPackage.Class DiagramsToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						...
						CreateElementToolPrototype(store, global::AgileFx.AgileModeler.ModelClass.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "AgileFx.AgileModeler.DslPackage.AssociationToolboxItem":

					// Add Association connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"AgileFx.AgileModeler.DslPackage.AssociationToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"AgileFx.AgileModeler.DslPackage.Class DiagramsToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Class DiagramsToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"AssociationF1Keyword", // F1 help keyword for the toolbox item.
					...
					break;
				case "AgileFx.AgileModeler.DslPackage.InheritanceToolboxItem":

					// Add Inheritance connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"AgileFx.AgileModeler.DslPackage.InheritanceToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"AgileFx.AgileModeler.DslPackage.Class DiagramsToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Class DiagramsToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"InheritanceF1Keyword", // F1 help keyword for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::AgileFx.AgileModeler.AgileModelerDomainModel));
