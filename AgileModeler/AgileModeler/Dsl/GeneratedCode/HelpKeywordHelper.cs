...
namespace AgileFx.AgileModeler
{
	...
	/// </remarks>
	public partial class AgileModelerHelpKeywordHelper : AgileModelerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new AgileModelerHelpKeywordHelper.
		/// </summary>
		protected AgileModelerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the AgileModelerHelpKeywordHelper.
		/// </summary>
		public static AgileModelerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class AgileModelerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new AgileModelerHelpKeywordHelperBase.
		/// </summary>
		protected AgileModelerHelpKeywordHelperBase()
			: base() { }
