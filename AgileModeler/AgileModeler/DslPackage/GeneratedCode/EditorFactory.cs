...
namespace AgileFx.AgileModeler.DslPackage
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.AgileModelerEditorFactoryId)]
	internal partial class AgileModelerEditorFactory : AgileModelerEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new AgileModelerEditorFactory.
		/// </summary>
		public AgileModelerEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class AgileModelerEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected AgileModelerEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new AgileModelerDocData(this.ServiceProvider, typeof(AgileModelerEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new AgileModelerDocView(docData, this.ServiceProvider);
		}
	}
}
