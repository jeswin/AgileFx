...
namespace AgileFx.AgileModeler.DslPackage
{
	...
	{
		/// <summary>
		/// Constructs a new AgileModelerCommandSet.
		/// </summary>
		public AgileModelerCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class AgileModelerCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new AgileModelerCommandSetBase.
		/// </summary>
		protected AgileModelerCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewAgileModelerExplorerCommand,
				typeof(AgileModelerEditorFactory).GUID);
		...
		{
			AgileModelerExplorerToolWindow explorer = this.AgileModelerExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentAgileModelerDocData != null && this.CurrentAgileModelerDocData.Store != null)
			{
				this.CurrentAgileModelerDocData.ValidationController.Validate(this.CurrentAgileModelerDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentAgileModelerDocData != null && this.CurrentAgileModelerDocData.Store != null)
			{
				...
				this.CurrentAgileModelerDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected AgileModelerDocData CurrentAgileModelerDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as AgileModelerDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected AgileModelerDocView CurrentAgileModelerDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as AgileModelerDocView;
			}
		}
		...
		/// </summary>
		protected AgileModelerExplorerToolWindow AgileModelerExplorerToolWindow
		{
			get
			{
				AgileModelerExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(AgileModelerExplorerToolWindow), true) as AgileModelerExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				AgileModelerExplorerToolWindow explorerWindow = this.AgileModelerExplorerToolWindow;
