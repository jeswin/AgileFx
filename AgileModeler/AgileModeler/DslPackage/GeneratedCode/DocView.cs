...
namespace AgileFx.AgileModeler.DslPackage
{
	...
	/// </summary>
	internal partial class AgileModelerDocView : AgileModelerDocViewBase
	{
		/// <summary>
		/// Constructs a new AgileModelerDocView.
		/// </summary>
		public AgileModelerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class AgileModelerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new AgileModelerDocView.
		/// </summary>
		protected AgileModelerDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			AgileModelerDocDataBase docData = this.DocData as AgileModelerDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for AgileModelerDocViewBase should be an AgileModelerDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::AgileFx.AgileModeler.ClassDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::AgileFx.AgileModeler.ClassDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::AgileFx.AgileModeler.AgileModelerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::AgileFx.AgileModeler.AgileModelerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.AgileModelerDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::AgileFx.AgileModeler.AgileModelerHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::AgileFx.AgileModeler.AgileModelerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::AgileFx.AgileModeler.AgileModelerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
