...
namespace AgileFx.ORM
{
    ...
    public class EntityCollection<TEntity, TIntermediateEntity> : ICollection<TEntity>, IEntityCollection
        where TEntity : IEntity<TIntermediateEntity>
        where TIntermediateEntity : IntermediateEntity<TEntity>
    {
        ICollection<TIntermediateEntity> intermediateCollection;
        public EntityCollection(ICollection<TIntermediateEntity> intermediateCollection)
        {
